...
pygame.init()
overImg_lose= pygame.image.load('ben10.jpg')
overImg_win= pygame.image.load('ben10background.jpg')
...
while True:
	...
	while lose == True and start == False:
		DISPLAYSURF.fill(brown)
		DISPLAYSURF.blit(ben_cover,(0,0))
	...
	while win == True and start == False:
		DISPLAYSURF.fill(brown)
		DISPLAYSURF.blit(ben_cover,(0,0))
		DISPLAYSURF.blit(textPlayAgain, textPlayAgainObj)
